...
using Testability.Presidents.WebUI.Controllers;
...
namespace Testability.Presidents.MvcIntegrationTests
{
    [TestClass]
    public class PresidentRoutingFixture
    {
        private WebApplicationFactory<Testability.Presidents.WebUi.Startup> _SystemUnderTest;
        public WebApplicationFactory<Testability.Presidents.WebUi.Startup> SystemUnderTest
        {
            get
            {
                ...
                {
                    _SystemUnderTest =
                        new WebApplicationFactory<Testability.Presidents.WebUi.Startup>();
                }
